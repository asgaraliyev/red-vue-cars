            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
              {car.features.map((feature, index) => {
                ...
                return (
                  <div key={index} className="flex flex-col items-center justify-center p-4 bg-muted rounded-lg">
                    <FeatureIcon className="h-8 w-8 mb-2 text-primary" />
                    <span className="font-medium text-lg">{feature.label}</span>
                  </div>
                );
              })}
              <div className="flex flex-col items-center justify-center p-4 bg-muted rounded-lg">
                {(() => {
                  ...
                  return <MileageIcon className="h-8 w-8 mb-2 text-primary" />;
                })()}
              ...
              <div className="flex flex-col items-center justify-center p-4 bg-muted rounded-lg">
                {(() => {
                  ...
                  return <EngineIcon className="h-8 w-8 mb-2 text-primary" />;
                })()}
              ...
              <div className="flex flex-col items-center justify-center p-4 bg-muted rounded-lg">
                {(() => {
                  ...
                  return <FuelIcon className="h-8 w-8 mb-2 text-primary" />;
                })()}
