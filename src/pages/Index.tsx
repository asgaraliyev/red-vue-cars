  ...
  return (
    <div className="min-h-screen bg-gradient-secondary">
      ...
      <main className="container mx-auto px-4 py-8">
        <div ref={carCardRef} className="relative rounded-2xl overflow-hidden shadow-elevated bg-card">
          <div className="relative h-[75vh] min-h-[700px]">
            ...
            <div className="absolute top-6 right-6 z-10">
              <Badge className="bg-primary text-primary-foreground font-bold text-base px-5 py-1.5 shadow-lg">
                {car.auctionDate}
              </Badge>
            </div>
